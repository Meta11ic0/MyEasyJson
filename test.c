...
#define TEST_STRING(expect, json)\
    do {\
        ...
        easyjson_init(&v);\
        EXPECT_EQ_INT(EASYJSON_PARSE_OK, easyjson_parse(&v, json));\
        EXPECT_EQ_INT(EASYJSON_STRING, easyjson_get_type(&v));\
        EXPECT_EQ_STRING(expect, easyjson_get_string(&v), easyjson_get_string_length(&v));\
        easyjson_free(&v);\
    } while(0)
...
{
    TEST_ERROR(EASYJSON_PARSE_MISS_QUOTATION_MARK, "\"");
    TEST_ERROR(EASYJSON_PARSE_MISS_QUOTATION_MARK, "\"abc");
}

static void test_parse_invalid_string_escape() 
{
#if 0
    TEST_ERROR(EASYJSON_PARSE_INVALID_STRING_ESCAPE, "\"\\v\"");
    TEST_ERROR(EASYJSON_PARSE_INVALID_STRING_ESCAPE, "\"\\'\"");
    TEST_ERROR(EASYJSON_PARSE_INVALID_STRING_ESCAPE, "\"\\0\"");
    TEST_ERROR(EASYJSON_PARSE_INVALID_STRING_ESCAPE, "\"\\x12\"");
#endif
}
...
{
#if 0
    TEST_ERROR(EASYJSON_PARSE_INVALID_STRING_CHAR, "\"\x01\"");
    TEST_ERROR(EASYJSON_PARSE_INVALID_STRING_CHAR, "\"\x1F\"");
#endif
}
